...
public class CollectibleScriptFlyOnCoin : MonoBehaviour
{
   ...
   // public AudioClip collectSound;
    ...
    [SerializeField] private int numberShootSoundClip=4;

    // Use this for initialization
    void Start()
    {
        collectorCoinsFictive = GameObject.Find("CollectorCoinsFictiveCoin");
